...
class _VerifyOneState extends State<VerifyOne> {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      SizedBox(height: 20),
      Text("A verification code was sent to your email", style: TextStyle(color: Colors.black,fontSize: 14,)),

      Text("johndoe@gmail.com", style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold)),
      Text("Edit email address", style: TextStyle(color: Colors.black,fontSize: 15,)),
